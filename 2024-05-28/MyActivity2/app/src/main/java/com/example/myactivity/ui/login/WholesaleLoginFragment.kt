package com.example.myactivity.ui.wholesale
...
import com.example.myactivity.databinding.FragmentWholesaleLoginBinding

class WholesaleLoginFragment : Fragment() {
    // View Binding을 위한 변수 - Variable for View Binding
    private var _binding: FragmentWholesaleLoginBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentWholesaleLoginBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupUI() {
        ...
        val wholesaleLoginButton: Button = binding.wholesaleloginButton
        val wholesaleNaverLoginButton: Button = binding.wholesalenaverLoginButton
        ...
        wholesaleLoginButton.setOnClickListener {
        ...
        wholesaleNaverLoginButton.setOnClickListener {
