...
class HomeActivity : AppCompatActivity() {
        ...
        val stringRequest = object : StringRequest(
            ...
            Response.Listener { response ->
                ...
                try {
                    ...
                    val user = User(userId = 2, email = email, userPhoneNumber = phone, username = username, lat = 999.666, lng = 666.999, userPassword = "666")
    ...
    private fun loginuser(){
        val user = User(userId = null, username = "hiendzvcl1", email = "hiendz1@example.com",lat = 9999.9999,lng = 999999.99, userPhoneNumber = "666" , userPassword = "666")
