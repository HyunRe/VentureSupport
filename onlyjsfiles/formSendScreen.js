...
//import formInputScreen from './src/formInputScreen';

const FormSendScreen = () => {
  ...
  useEffect(() => {
    if (routeNparams) {
      const { deadline, location, productName, totalAmount } = routeNparams;
  ...
  const handleFormSubmit = () => {
    const serverURL = 'http://223.194.157.56:8080/order';
